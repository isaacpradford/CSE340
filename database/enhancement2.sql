...
(
	...
	client_type client_type NOT NULL DEFAULT 'client'::client_type, -- note 'client' is lower cased
...
SELECT inventory.inv_model, inventory.classification_id, classification.classification_name
FROM inventory
	INNER JOIN classification
